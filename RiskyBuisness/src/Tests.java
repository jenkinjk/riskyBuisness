...
public class Tests {
	...
	public void getNeighborsNorthEurope() throws Exception{
		RiskBoard board = new RiskBoard();
		board.initialGame(fInput);
		ArrayList<Territory> neighbors = board.getTerritoryNamed("Northen Europe").getNeighbors();
		assertTrue(neighbors.contains(board.getTerritoryNamed("Southern Europe")));
		assertTrue(neighbors.contains(board.getTerritoryNamed("Scandinavia")));
		assertTrue(neighbors.contains(board.getTerritoryNamed("Ukraine")));
	...
	public void getNeighborsGreatBritain() throws Exception{
		RiskBoard board = new RiskBoard();
		board.initialGame(fInput);
		ArrayList<Territory> neighbors = board.getTerritoryNamed("Great Britain").getNeighbors();
		assertTrue(neighbors.contains(board.getTerritoryNamed("Iceland")));
		assertTrue(neighbors.contains(board.getTerritoryNamed("Scandinavia")));
		assertTrue(neighbors.contains(board.getTerritoryNamed("Northen Europe")));
		assertTrue(neighbors.contains(board.getTerritoryNamed("Southern Europe")));
	...
	public void getNeighborsArgentina() throws Exception{
		RiskBoard board = new RiskBoard();
		board.initialGame(fInput);
		ArrayList<Territory> neighbors = board.getTerritoryNamed("Argentina").getNeighbors();
		assertTrue(neighbors.contains(board.getTerritoryNamed("Brazil")));
		assertTrue(neighbors.contains(board.getTerritoryNamed("Peru")));
		assertTrue(neighbors.size()==2);
	}
	...
	public void getNeighborsVenezuela() throws Exception{
		RiskBoard board = new RiskBoard();
		board.initialGame(fInput);
		ArrayList<Territory> neighbors = board.getTerritoryNamed("Venezula").getNeighbors();
		assertTrue(neighbors.contains(board.getTerritoryNamed("Brazil")));
		assertTrue(neighbors.contains(board.getTerritoryNamed("Peru")));
		assertTrue(neighbors.contains(board.getTerritoryNamed("Centeral America")));
		assertTrue(neighbors.size()==3);
	...
	public void getNeighborsCongo() throws Exception{
		RiskBoard board = new RiskBoard();
		board.initialGame(fInput);
		ArrayList<Territory> neighbors = board.getTerritoryNamed("Congo").getNeighbors();
		assertTrue(neighbors.contains(board.getTerritoryNamed("North Africa")));
	...
	public void getNeighborsEastAfrica() throws Exception{
		RiskBoard board = new RiskBoard();
		board.initialGame(fInput);
		ArrayList<Territory> neighbors = board.getTerritoryNamed("East Africa").getNeighbors();
	...
	public void getNeighborsEastAust() throws Exception{
		RiskBoard board = new RiskBoard();
		board.initialGame(fInput);
		ArrayList<Territory> neighbors = board.getTerritoryNamed("Eastern Australia").getNeighbors();
	...
	public void getNeighborsIndonesia() throws Exception{
		RiskBoard board = new RiskBoard();
		board.initialGame(fInput);
		ArrayList<Territory> neighbors = board.getTerritoryNamed("Indonesia").getNeighbors();
		assertTrue(neighbors.contains(board.getTerritoryNamed("Siam")));
		assertTrue(neighbors.contains(board.getTerritoryNamed("Western Australia")));
		assertTrue(neighbors.contains(board.getTerritoryNamed("New Guinea")));
		assertTrue(neighbors.size()==3);
	...
	public void getNeighborsNewGuinea() throws Exception{
		RiskBoard board = new RiskBoard();
		board.initialGame(fInput);
		ArrayList<Territory> neighbors = board.getTerritoryNamed("New Guinea").getNeighbors();
		assertTrue(neighbors.contains(board.getTerritoryNamed("Indonesia")));
		assertTrue(neighbors.contains(board.getTerritoryNamed("Eastern Australia")));
		assertTrue(neighbors.size()==2);
	}
	@Test
	public void getNeighborsWestAust() throws Exception{
		RiskBoard board = new RiskBoard();
		board.initialGame(fInput);
		ArrayList<Territory> neighbors = board.getTerritoryNamed("Western Australia").getNeighbors();
		assertTrue(neighbors.contains(board.getTerritoryNamed("Eastern Australia")));
		assertTrue(neighbors.contains(board.getTerritoryNamed("Indonesia")));
		assertTrue(neighbors.size()==2);
	}
