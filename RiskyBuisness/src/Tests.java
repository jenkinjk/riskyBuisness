...
//	}
	...
	@Test
	public void TerritoryArmyStorage() {
		RiskBoard board = new RiskBoard();
		board.initialGame(fInput);
		Territory Alaska=null;
		try {
			Alaska = board.getTerritoryNamed("Alaska");
		} catch (Exception e) {
			e.printStackTrace();
		}
		Army army = Alaska.getArmy();
		assertTrue(army.getArmyLocation().equals(Alaska));
	}
	...
	public void armyListenerStorageTest() {
		...
		Army army = null;
		try {
			army = board.getTerritoryNamed("Alaska").getArmy();
		} catch (Exception e) {
